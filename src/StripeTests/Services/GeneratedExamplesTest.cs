...
namespace StripeTests
{
    ...
    public class GeneratedExamplesTest : BaseStripeTest
    {
        ...
        [Fact]
        public void TestCustomerCashBalanceTransactionServiceList()
        {
        ...
        [Fact]
        public void TestCustomerCashBalanceTransactionServiceRetrieve()
        {
            var service = new CustomerCashBalanceTransactionService(
                this.StripeClient);
            service.Get("cus_xxxxxxxxxxxxx", "ccsbtxn_xxxxxxxxxxxxx");
        }
        ...
        [Fact]
        public void TestCustomerServiceRetrievePaymentMethod()
        {
            var service = new CustomerService(this.StripeClient);
            service.RetrievePaymentMethod(
                "cus_xxxxxxxxxxxxx",
                "pm_xxxxxxxxxxxxx");
        }
